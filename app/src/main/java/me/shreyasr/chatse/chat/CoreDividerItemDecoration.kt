 ...
 */
class CoreDividerItemDecoration @JvmOverloads constructor(context: Context, orientation: Int = CoreDividerItemDecoration.VERTICAL_LIST) : RecyclerView.ItemDecoration() {
    /**
